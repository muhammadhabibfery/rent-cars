    ...
    <div class="row justify-content-center mb-5">
        <div class="col-md-8">
            <div class="card mt-3">
                <div class="row">
                    <div class="col-10">
                        <h5 class="card-header">Form Tambah Customer</h5>
                    </div>
                    <div class="col-2">
                ...
                <div class="card-body">
                    <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data" id="myfr">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="gambar">Profil Customer</label>
                            <small class="ml-2">(*opsional)</small>
